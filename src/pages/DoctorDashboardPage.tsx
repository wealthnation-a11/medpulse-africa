...
export default function DoctorDashboardPage() {
  ...
  return (
    <AppLayout>
      <DoctorDashboard observations={observations} displayName={displayName} casesOverTime={casesOverTime} symptomChartData={symptomChartData} />
    </AppLayout>
  );
}